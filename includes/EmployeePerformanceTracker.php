...
final class EmployeePerformanceTracker {
	...
	private function __construct() {
		...
		register_activation_hook( EMPLOYEE_PERFORMANCE_TRACKER_FILE, array( $this, 'activate' ) );
		register_deactivation_hook( EMPLOYEE_PERFORMANCE_TRACKER_FILE, array( $this, 'deactivate' ) );
